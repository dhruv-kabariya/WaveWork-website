...
export default function PrivacyPolicy() {
  ...
  return (
    <Box component={"div"} className="mx-auto mb-5 col-lg-8 col-md-10 col-12 px-1 d-flex flex-column" sx={{ marginTop: "85px" }}>
      ...
      <Typography variant="h5" component={"h1"} className="mt-3" sx={{ fontWeight: "600" }} id="toc">TABLE OF CONTENTS</Typography>
      ...
      <Typography variant="h5" component={"h1"} className="mt-5" sx={{ fontWeight: "600" }} id="infocollect">1. WHAT INFORMATION DO WE COLLECT?</Typography>
      <Typography variant="h6" component={"h3"} className="mt-3" sx={{ fontWeight: "600" }} id="personalinfo">Personal information you disclose to us</Typography>
      ...
      <Typography variant="h5" component={"h1"} className="mt-5" sx={{ fontWeight: "600" }} id="infouse">2. HOW DO WE PROCESS YOUR INFORMATION?</Typography>
      ...
      <Typography variant="h5" component={"h1"} className="mt-5" sx={{ fontWeight: "600" }} id="infouse">3. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</Typography>
      ...
      <Typography variant="h5" component={"h1"} className="mt-5" sx={{ fontWeight: "600" }} id="inforetain">5. HOW LONG DO WE KEEP YOUR INFORMATION?</Typography>
      ...
      <Typography variant="h5" component={"h1"} className="mt-5" sx={{ fontWeight: "600" }} id="privacyrights">8. WHAT ARE YOUR PRIVACY RIGHTS?</Typography>
      ...
      <Typography variant="h5" component={"h1"} className="mt-5" sx={{ fontWeight: "600" }} id="policyupdates">11. DO WE MAKE UPDATES TO THIS NOTICE?</Typography>
      ...
      <Typography variant="h5" component={"h1"} className="mt-5" sx={{ fontWeight: "600" }} id="request">13. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</Typography>
