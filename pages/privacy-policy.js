    ...
    <>
      ...
      <Box component={"div"} className="mx-auto mb-5 col-lg-8 col-md-10 col-12 px-1 d-flex flex-column" sx={{ marginTop: "85px" }}>
        ...
        <Typography variant="body1" component={"p"} sx={{ ...basicStyle }} className="mt-3">
          This privacy notice for WorkWaves (<strong>&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;</strong>), describes how and why we might collect, store, use, and/or share (<strong>&quot;process&quot;</strong>) your information when you use our services (<strong>&quot;Services&quot;</strong>), such as when you:
        </Typography>
        <ul style={{ ...basicStyle }} className="mt-2 ms-3">
          <li>
            <Typography variant="body1" component={"p"} sx={{ color: 'rgb(89, 89, 89)', fontSize: '15px' }} className="mt-3">
              Download and use our mobile application (WorkWaves), or any other application of ours that links to this privacy notice.
            </Typography>
          </li>
          <li>
            <Typography variant="body1" component={"p"} sx={{ color: 'rgb(89, 89, 89)', fontSize: '15px' }} className="mt-3">
        ...
        <Typography variant="body1" component={"p"} sx={{ ...basicStyle }} className="mt-4">WorkWaves</Typography>
